package org.daq.common.mybatis.handler;
...
import org.daq.common.core.domain.dto.RoleDTO;
import org.daq.common.core.domain.model.LoginUser;
import org.daq.common.core.exception.ServiceException;
import org.daq.common.core.utils.SpringUtils;
import org.daq.common.core.utils.StreamUtils;
import org.daq.common.core.utils.StringUtils;
import org.daq.common.mybatis.annotation.DataColumn;
import org.daq.common.mybatis.annotation.DataPermission;
import org.daq.common.mybatis.enums.DataScopeType;
import org.daq.common.mybatis.helper.DataPermissionHelper;
import org.daq.common.satoken.utils.LoginHelper;
        ...
        for (RoleDTO role : user.getRoles()) {
            ...
            for (DataColumn dataColumn : dataPermission.value()) {
                ...
                if (ignoreMap.containsKey(dataColumn)) {
                    // 修复多角色与权限标识符共用问题 https://gitee.com/dromara/Daq/issues/IB4CS4
